...
public class routes {
  ...
  public static final controllers.ReverseItemScoreController ItemScoreController = new controllers.ReverseItemScoreController(RoutesPrefix.byNamePrefix());
  public static final controllers.ReverseAssets Assets = new controllers.ReverseAssets(RoutesPrefix.byNamePrefix());
  public static final controllers.ReverseItemReviewController ItemReviewController = new controllers.ReverseItemReviewController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseItemScoreController ItemScoreController = new controllers.javascript.ReverseItemScoreController(RoutesPrefix.byNamePrefix());
    public static final controllers.javascript.ReverseAssets Assets = new controllers.javascript.ReverseAssets(RoutesPrefix.byNamePrefix());
    public static final controllers.javascript.ReverseItemReviewController ItemReviewController = new controllers.javascript.ReverseItemReviewController(RoutesPrefix.byNamePrefix());
